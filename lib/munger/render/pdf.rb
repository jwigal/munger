  ...
  module Render #:nodoc:
    class Pdf
      ...
      def pdf
        ...
        file_base = File.expand_path('../../../fonts', File.dirname(__FILE__))
        @pdf.font_families.update({"DejaVuSans" => {
          :normal      => "#{file_base}/DejaVuSans.ttf",
          :italic      => "#{file_base}/DejaVuSans-Oblique.ttf",
          :bold        => "#{file_base}/DejaVuSans-Bold.ttf",
          :bold_italic => "#{file_base}/DejaVuSans-BoldOblique.ttf"
        }})
        @pdf.font_families.update({"Roboto" => {
          :normal      => "#{file_base}/Roboto-Regular.ttf",
          :italic      => "#{file_base}/Roboto-Italic.ttf",
          :bold        => "#{file_base}/Roboto-Bold.ttf",
          :bold_italic => "#{file_base}/Roboto-BoldItalic.ttf"
        }})
        @pdf.font_families.update({"RobotoSlab" => {
          :normal      => "#{file_base}/RobotoSlab-Regular.ttf",
          :italic      => "#{file_base}/RobotoSlab-Regular.ttf",
          :bold        => "#{file_base}/RobotoSlab-Bold.ttf",
          :bold_italic => "#{file_base}/RobotoSlab-Bold.ttf"
        }})
        @pdf
      end
